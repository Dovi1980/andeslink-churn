# Informe Hito 1 - AndesLink Churn Prediction
...
_Razón:_ Para AndesLink es preferible contactar a un cliente que no se iba a ir (Falso Positivo) que perder a un cliente real por no detectarlo (Falso Negativo).
