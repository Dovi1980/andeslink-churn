...
1. **Impacto de la Antigüedad (`tenure_months`):**
   ...
   * La propensión al abandono es sumamente alta durante los primeros 3 a 6 meses de servicio (*onboarding*). A medida que el usuario supera los 12 meses, la fidelización se consolida y el churn disminuye drásticamente.
...
* **MLflow:** Almacena de manera estructurada el histórico de experimentos, registrando las métricas del modelo final y su firma de datos (*signature*) para el despliegue automático del Hito 2.
